...
extern "C" {
    ...
    pub fn AcpiOsPredefinedOverride(InitVal: *const ACPI_PREDEFINED_NAMES,
                                    NewVal: *mut ACPI_STRING) -> ACPI_STATUS;
    pub fn AcpiOsTableOverride(ExistingTable: *mut ACPI_TABLE_HEADER,
                               NewTable: *mut *mut ACPI_TABLE_HEADER)
     -> ACPI_STATUS;
    pub fn AcpiOsPhysicalTableOverride(ExistingTable: *mut ACPI_TABLE_HEADER,
                                       NewAddress: *mut ACPI_PHYSICAL_ADDRESS,
                                       NewTableLength: *mut UINT32)
     -> ACPI_STATUS;
    pub fn AcpiOsCreateLock(OutHandle: *mut *mut c_void)
     -> ACPI_STATUS;
    pub fn AcpiOsDeleteLock(Handle: *mut c_void);
    pub fn AcpiOsAcquireLock(Handle: *mut c_void)
     -> ACPI_SIZE;
    pub fn AcpiOsReleaseLock(Handle: *mut c_void,
                             Flags: ACPI_SIZE);
    pub fn AcpiOsCreateSemaphore(MaxUnits: UINT32, InitialUnits: UINT32,
                                 OutHandle: *mut *mut c_void)
     -> ACPI_STATUS;
    pub fn AcpiOsDeleteSemaphore(Handle: *mut c_void)
     -> ACPI_STATUS;
    pub fn AcpiOsWaitSemaphore(Handle: *mut c_void,
                               Units: UINT32, Timeout: UINT16) -> ACPI_STATUS;
    pub fn AcpiOsSignalSemaphore(Handle: *mut c_void,
                                 Units: UINT32) -> ACPI_STATUS;
    pub fn AcpiOsAllocate(Size: ACPI_SIZE) -> *mut c_void;
    pub fn AcpiOsAllocateZeroed(Size: ACPI_SIZE)
     -> *mut c_void;
    pub fn AcpiOsFree(Memory: *mut c_void);
    pub fn AcpiOsMapMemory(Where: ACPI_PHYSICAL_ADDRESS, Length: ACPI_SIZE)
     -> *mut c_void;
    pub fn AcpiOsUnmapMemory(LogicalAddress: *mut c_void,
                             Size: ACPI_SIZE);
    pub fn AcpiOsGetPhysicalAddress(LogicalAddress:
                                        *mut c_void,
                                    PhysicalAddress:
                                        *mut ACPI_PHYSICAL_ADDRESS)
     -> ACPI_STATUS;
    pub fn AcpiOsCreateCache(CacheName: *mut i8,
    ...
    pub fn AcpiOsAcquireObject(Cache: *mut ACPI_MEMORY_LIST)
     -> *mut c_void;
    pub fn AcpiOsReleaseObject(Cache: *mut ACPI_MEMORY_LIST,
                               Object: *mut c_void)
     -> ACPI_STATUS;
    pub fn AcpiOsInstallInterruptHandler(InterruptNumber: UINT32,
                                         ServiceRoutine: ACPI_OSD_HANDLER,
                                         Context: *mut c_void)
     -> ACPI_STATUS;
    pub fn AcpiOsRemoveInterruptHandler(InterruptNumber: UINT32,
                                        ServiceRoutine: ACPI_OSD_HANDLER)
     -> ACPI_STATUS;
    pub fn AcpiOsGetThreadId() -> UINT64;
    pub fn AcpiOsExecute(Type: ACPI_EXECUTE_TYPE,
    ...
    pub fn AcpiOsReadPort(Address: ACPI_IO_ADDRESS, Value: *mut UINT32,
                          Width: UINT32) -> ACPI_STATUS;
    pub fn AcpiOsWritePort(Address: ACPI_IO_ADDRESS, Value: UINT32,
                           Width: UINT32) -> ACPI_STATUS;
    pub fn AcpiOsReadMemory(Address: ACPI_PHYSICAL_ADDRESS,
                            Value: *mut UINT64, Width: UINT32) -> ACPI_STATUS;
    pub fn AcpiOsWriteMemory(Address: ACPI_PHYSICAL_ADDRESS, Value: UINT64,
                             Width: UINT32) -> ACPI_STATUS;
    pub fn AcpiOsReadPciConfiguration(PciId: *mut ACPI_PCI_ID, Reg: UINT32,
                                      Value: *mut UINT64, Width: UINT32)
     -> ACPI_STATUS;
    pub fn AcpiOsWritePciConfiguration(PciId: *mut ACPI_PCI_ID, Reg: UINT32,
                                       Value: UINT64, Width: UINT32)
     -> ACPI_STATUS;
    pub fn AcpiOsReadable(Pointer: *mut c_void,
                          Length: ACPI_SIZE) -> BOOLEAN;
    pub fn AcpiOsWritable(Pointer: *mut c_void,
                          Length: ACPI_SIZE) -> BOOLEAN;
    pub fn AcpiOsGetTimer() -> UINT64;
    pub fn AcpiOsSignal(Function: UINT32, Info: *mut c_void)
     -> ACPI_STATUS;
    pub fn AcpiOsPrintf(Format: *const i8, ...);
    pub fn AcpiOsVprintf(Format: *const i8,
                         Args: va_list);
    pub fn AcpiOsRedirectOutput(Destination: *mut c_void);
    pub fn AcpiOsGetLine(Buffer: *mut i8,
                         BufferLength: UINT32, BytesRead: *mut UINT32)
     -> ACPI_STATUS;
    pub fn AcpiOsGetTableByName(Signature: *mut i8,
                                Instance: UINT32,
                                Table: *mut *mut ACPI_TABLE_HEADER,
                                Address: *mut ACPI_PHYSICAL_ADDRESS)
     -> ACPI_STATUS;
    pub fn AcpiOsGetTableByIndex(Index: UINT32,
                                 Table: *mut *mut ACPI_TABLE_HEADER,
                                 Instance: *mut UINT32,
                                 Address: *mut ACPI_PHYSICAL_ADDRESS)
     -> ACPI_STATUS;
    pub fn AcpiOsGetTableByAddress(Address: ACPI_PHYSICAL_ADDRESS,
                                   Table: *mut *mut ACPI_TABLE_HEADER)
     -> ACPI_STATUS;
    pub fn AcpiOsOpenDirectory(Pathname: *mut i8,
                               WildcardSpec: *mut i8,
                               RequestedFileType: i8)
     -> *mut c_void;
    pub fn AcpiOsGetNextFilename(DirHandle: *mut c_void)
     -> *mut i8;
    pub fn AcpiOsCloseDirectory(DirHandle: *mut c_void);
    pub fn AcpiOsOpenFile(Path: *const i8, Modes: UINT8)
     -> *mut c_void;
    pub fn AcpiOsCloseFile(File: *mut c_void);
    pub fn AcpiOsReadFile(File: *mut c_void,
                          Buffer: *mut c_void,
                          Size: ACPI_SIZE, Count: ACPI_SIZE)
     -> i32;
    pub fn AcpiOsWriteFile(File: *mut c_void,
                           Buffer: *mut c_void,
                           Size: ACPI_SIZE, Count: ACPI_SIZE)
     -> i32;
    pub fn AcpiOsGetFileOffset(File: *mut c_void)
     -> i32;
    pub fn AcpiOsSetFileOffset(File: *mut c_void,
                               Offset: i32, From: UINT8)
     -> ACPI_STATUS;
    pub fn AcpiOsTracePoint(Type: ACPI_TRACE_EVENT_TYPE, Begin: BOOLEAN,
                            Aml: *mut UINT8,
                            Pathname: *mut i8);
